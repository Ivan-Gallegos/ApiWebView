...
class Repository private constructor(
    ...
    suspend fun getQueryResponse(query: String): QueryResponse = withContext(IO) {
     ...
     */
    private suspend fun getValidDbResponse(query: String): QueryResponse? = withContext(IO) {
     ...
     */
    private suspend fun getNetworkResponse(query: String): QueryResponse = withContext(IO) {
        try {
            ...
            }.let { QueryResponse(it, fromNetwork = true) }
